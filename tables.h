...
// Progmem ref: https://www.arduino.cc/reference/en/language/variables/utilities/progmem/

#ifndef _TABLES
#define _TABLES

//This table id compatible with 20000.00 Hz. sampling rate
//Envelope phase increment vs. MIDI range value [0-127]
...
//Wave phase increment vs. MIDI note [0-127]
...
const PROGMEM unsigned char AttackDecayTable[]=
{
	1,	//0
	3,	//1
	5,	//2
